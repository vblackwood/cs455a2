...
----------- | --------------------------------------------- | --------       | -------------------------------------
1           | Server lets user know if no match is found    | 12345678       | No matches found for "12345678"
2           | Server replies all results to client if match | Florence       | [all zip codes for all Florences in the U.S.]
3           | Both city AND state match                     | Huntsville, AL | Match found for "Huntsville, AL" -> Huntsville, AL is zipcode 35801 [repeat for every zip in Huntsville, AL]
